...
### Analysis of editors
For each Editor of a special issue, the proportion of Editor RTs below the 5th percentile cutoff was determined. Using this approach, a set of editors was selected for further scrutiny.  
...
```{r bit}
#create list with just one row for each of the nued editors. 
